...
def proposal_layer(rpn_cls_prob_reshape, rpn_bbox_pred, im_info, cfg_key, _feat_stride=[16, ], anchor_scales=[16, ]):
    ...
    # print("proposal_layer: _anchors is {}".format(_anchors))
    ...
    # print(
    #     "proposal_layer: pre_nms_topN is {}."
    #     "post_nms_topN is {}. "
    #     "nms_thresh is {}. "
    #     "min_zie is {}.".format(pre_nms_topN, post_nms_topN, nms_thresh, min_size))
    ...
    # (1, H, W, A)
    print("proposal_layer: the shape of rpn_cls_prob_reshape is {}".format(rpn_cls_prob_reshape.shape))
    ...
    # Builds the upper-left coordinates of all cells
    # print("proposal_layer: shift_x is {}. shift_y is {}".format(shift_x, shift_y))
    shift_x, shift_y = np.meshgrid(shift_x, shift_y)
    # print("proposal_layer: shift_x is {}. shift_y is {}".format(shift_x, shift_y))
    shifts = np.vstack((shift_x.ravel(), shift_y.ravel(),
                        shift_x.ravel(), shift_y.ravel())).transpose()
    # print("proposal_layer: shifts is {}".format(shifts))
    ...
    print("proposal_layer: the shape of anchors is {}".format(anchors.shape))
    ...
    print("proposal_layer: the shape of bbox_deltas is {}".format(bbox_deltas.shape))
    # Same story for the scores:
    scores = scores.reshape((-1, 1))
    print("proposal_layer: the shape of scores is {}".format(scores.shape))
